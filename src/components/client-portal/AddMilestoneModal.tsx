...
import { X, Calendar, DollarSign, FileText, Tag, Clock, Send } from "lucide-react";
  ...
  return (
    <Modal onClose={onClose}>
      ...
      >
        ...
        <div>
          <div className="text-foreground font-bold text-sm">Add Payment Milestone</div>
      ...
      <form onSubmit={handleSubmit} className="p-5 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            style={{ 
              ...
              borderColor: description ? `${color}50` : "hsl(var(--border))",
            }}
            required
          />
        </div>
        ...
        <div className="flex gap-2 pt-4">
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.97 }}
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold text-white disabled:opacity-50 disabled:cursor-not-allowed"
            style={{ 
              background: color, 
